...
def pick_object_reverse(object_position=None, final_destination=None, retain=False, execute=False):
    # Check the parameter
    if object_position is None or len(object_position) < 3:
        return []
...
def place_object_reverse(place_destination=None, final_destination=None, execute=False):
    # Check the parameter
    if place_destination is None or len(place_destination) < 3:
        return []
...
def pick_and_place_object_reverse(object_position=None, place_destination=None, execute=False):
    # Check the parameter
    if place_destination is None or len(place_destination) < 3:
        return []
    ...
    # append instructions
    temp.append_all_instructions(pick_object_reverse(object_position=object_position, execute=False))
    temp.append_all_instructions(place_object_reverse(place_destination=place_destination, execute=False))
